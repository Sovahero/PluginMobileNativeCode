#import "IOS/ObjC/TestIosClass.h"
//================================================
@implementation TestIosClass
...
{
    static TestIosClass *staticTestIosClass;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        staticTestIosClass = [[self alloc] init];
    });
    return staticTestIosClass;
}

// #~~~~~~~~~~~~~~~~~~~~~~~~~~~ begin 1 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//----- Вызов IOS кода синхроно / Calling IOS code synchronously -------------------
...
// #~~~~~~~~~~~~~~~~~~~~~~~~~~~ begin 2 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//----- Вызов IOS кода асинхроно и возвращение значения обратно в C++
...
+ (void) asyncHelloWorldOnIOS:(NSString*)text
{
	dispatch_async(dispatch_get_main_queue(), ^{
		NSString* tmpStr = @" on IOS";
		NSString* ReturnText = [text stringByAppendingString: tmpStr];
		UPLUGIN_NAMEBPLibrary::CallBackCPP_IOS(ReturnText);
	});
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~ end 2 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// #~~~~~~~~~~~~~~~~~~~~~~~~~~ begin 5 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//----- Path to "/var/mobile/Containers/Data/Application/23D4996A6-BCC9-4C2F-A8B4-306BEB087BDB/Library/Caches/" --------
